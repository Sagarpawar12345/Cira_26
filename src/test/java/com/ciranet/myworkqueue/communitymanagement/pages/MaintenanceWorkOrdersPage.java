...
public class MaintenanceWorkOrdersPage extends BasePage
{
	...
	public boolean columnChooserClick() 
	{
		...
		waitForInvisibility(loaderIcon);
		clickElementJS(columnChooserButton);
		waitForInvisibility(loaderIcon);
	...
	public boolean toolBarNormalScreen() 
	{
		...
		if (isElementDisplayed(fullScreenIcon))
		{
			waitForInvisibility(loaderIcon);
			return true;
		} 
	...
	{
		if (isElementDisplayed(expandIcon)) 
		{
			waitForInvisibility(loaderIcon);
			viewedit();
