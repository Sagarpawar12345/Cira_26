...
public class FulfillmentQueuePage extends BasePage
{
	...
	@FindBy(xpath = "//span[normalize-space()='Fulfillment Queue']")
	...
	public void fulfillmentQueuePage() 
	{	
		...
		waitForInvisibility(loaderIcon);	
		scrollToElement(fulfillmentQueueMenu);
		clickElement(fulfillmentQueueMenu);
		waitForInvisibility(loaderIcon);
	}
	...
	public boolean columnChooserClick() 
	{
		...
		waitForInvisibility(columnChooserButton);
		clickElement(closeColChooserButton);
		waitForInvisibility(closeColChooserButton);
		return true;
	}

	public boolean switchTab() 
	{
		waitForInvisibility(closedJobsTab);	
